...
bool explore_lite_msgs__msg__explore_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("explore_lite_msgs.msg._explore_status.ExploreStatus", full_classname_dest, 51) == 0);
  }
  explore_lite_msgs__msg__ExploreStatus * ros_message = _ros_message;
  {  // status
...
{
  /* NOTE(esteve): Call constructor of ExploreStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("explore_lite_msgs.msg._explore_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ExploreStatus");
