...
explore_lite_msgs__msg__ExploreStatus__init(explore_lite_msgs__msg__ExploreStatus * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->status)) {
    explore_lite_msgs__msg__ExploreStatus__fini(msg);
    return false;
  }
  return true;
}
...
explore_lite_msgs__msg__ExploreStatus__create(void)
{
  ...
  explore_lite_msgs__msg__ExploreStatus * msg = (explore_lite_msgs__msg__ExploreStatus *)allocator.allocate(sizeof(explore_lite_msgs__msg__ExploreStatus), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(explore_lite_msgs__msg__ExploreStatus));
  bool success = explore_lite_msgs__msg__ExploreStatus__init(msg);
  if (!success) {
...
explore_lite_msgs__msg__ExploreStatus__Sequence__init(explore_lite_msgs__msg__ExploreStatus__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  explore_lite_msgs__msg__ExploreStatus * data = NULL;

  if (size) {
    data = (explore_lite_msgs__msg__ExploreStatus *)allocator.zero_allocate(size, sizeof(explore_lite_msgs__msg__ExploreStatus), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = explore_lite_msgs__msg__ExploreStatus__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        explore_lite_msgs__msg__ExploreStatus__fini(&data[i - 1]);
      }
...
explore_lite_msgs__msg__ExploreStatus__Sequence__fini(explore_lite_msgs__msg__ExploreStatus__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      explore_lite_msgs__msg__ExploreStatus__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  explore_lite_msgs__msg__ExploreStatus__Sequence * array = (explore_lite_msgs__msg__ExploreStatus__Sequence *)allocator.allocate(sizeof(explore_lite_msgs__msg__ExploreStatus__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = explore_lite_msgs__msg__ExploreStatus__Sequence__init(array, size);
  if (!success) {
...
explore_lite_msgs__msg__ExploreStatus__Sequence__destroy(explore_lite_msgs__msg__ExploreStatus__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    explore_lite_msgs__msg__ExploreStatus__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
explore_lite_msgs__msg__ExploreStatus__Sequence__are_equal(const explore_lite_msgs__msg__ExploreStatus__Sequence * lhs, const explore_lite_msgs__msg__ExploreStatus__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!explore_lite_msgs__msg__ExploreStatus__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  explore_lite_msgs__msg__ExploreStatus__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(explore_lite_msgs__msg__ExploreStatus);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    explore_lite_msgs__msg__ExploreStatus * data =
      (explore_lite_msgs__msg__ExploreStatus *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!explore_lite_msgs__msg__ExploreStatus__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          explore_lite_msgs__msg__ExploreStatus__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!explore_lite_msgs__msg__ExploreStatus__copy(
